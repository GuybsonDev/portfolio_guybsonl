  ...
  const data = [
    {
      ...
      name: 'Desenvolvimento API do PIB em Países Africanos',
    ...
    <section id="projetos" className="containerProjects" ref={ref}>
      ...
      >
        ...
        <motion.div
          ...
          <hr className="divider" />
          <a href={data[activeIndex].link} target="_blank" rel="noopener noreferrer" className="linkProject">Acesse o projeto aqui!</a>
        </motion.div>
      </motion.div>
    </section>
  );
